...
//~~~~~~Custom Moves~~~~~~//
//Light Type
#define MOVE_LAZERFIRE 0x2FF
#define MOVE_SEARINGSUN 0x300
#define MOVE_SOLARFLARE 0x301
#define MOVE_FLASHBANG 0x302
#define MOVE_LIGHTSPEEDPUNCH 0x303
#define MOVE_FOCUSEDBEAM 0x304
#define MOVE_PURITY 0x305
#define MOVE_CONCENTRATE 0x306
#define MOVE_HALLOWFOCUS 0x307
#define MOVE_LIGHTSHIELD 0x308
#define MOVE_SERENITY 0x309
#define MOVE_LUSTERSHOT 0x30A
#define MOVE_FINALLIGHT 0x30B
#define MOVE_SUNBEAM 0x30C
#define MOVE_RUINOUSLIGHT 0x30D
#define MOVE_BLINDED 0x30E
#define MOVE_CURINGLIGHT 0x30F

//Sound Type
#define MOVE_WARMUP 0x310
#define MOVE_DRUMROLL 0x311
#define MOVE_STRUM 0x312
#define MOVE_MELODY 0x313
#define MOVE_SEEDSHAKER 0x314
#define MOVE_SUDDENSHOUT 0x315
#define MOVE_PITCHPERFECT 0x316
#define MOVE_DEAFEN 0x317
#define MOVE_FINALE 0x318
#define MOVE_ACAPELLA 0x319
#define MOVE_FORTISSIMO 0x31A
#define MOVE_BEAMEDNOTE 0x31B
#define MOVE_HECKLE 0x31C
#define MOVE_BLUES 0x31D
#define MOVE_JAZZ 0x31E
#define MOVE_ROCKNROLL 0x31F
#define MOVE_POP 0x320
#define MOVE_RAP 0x321

//Cosmic Type
#define MOVE_GAMMARAY 0x322
#define MOVE_BLACKHOLE 0x323
#define MOVE_PULSAR 0x324
#define MOVE_FISSION 0x325
#define MOVE_FUSION 0x326
#define MOVE_METEORSHOWER 0x327
#define MOVE_STARBURST 0x328
#define MOVE_WARPDRIVE 0x329
#define MOVE_WORMHOLE 0x32A
#define MOVE_IRRADIATE 0x32B
#define MOVE_ASTEROIDBELT 0x32C
#define MOVE_COSMICRAY 0x32D
#define MOVE_GAMMAPOWER 0x32E
#define MOVE_RELATIVITY 0x32F
#define MOVE_BIGBANG 0x330
#define MOVE_ABDUCT 0x331
#define MOVE_NEUTRONSHOT 0x332

//Mystic Type
#define MOVE_STANDIN 0x333
#define MOVE_FLOURISH 0x334
#define MOVE_CONFUZZLE 0x335
#define MOVE_BEFUDDLE 0x336
#define MOVE_REHEARSAL 0x337
#define MOVE_SCREENTIME 0x338
#define MOVE_BREAKALEG 0x339
#define MOVE_PERFORMANCE 0x33A
#define MOVE_SWINDLE 0x33B
#define MOVE_INCANTATION 0x33C
#define MOVE_PRESTO 0x33D
#define MOVE_MAGICMISSILE 0x33E
#define MOVE_ENCHANT 0x33F
#define MOVE_ARCANEAETHER 0x340
#define MOVE_VORTEX 0x341
#define MOVE_TRANSMUTE 0x342
#define MOVE_CHAOSMAGIC 0x343

//Beast Type
#define MOVE_FORAGE 0x344
#define MOVE_MAUL 0x345
#define MOVE_FERALSTRIKES 0x346
#define MOVE_SAVAGE 0x347
#define MOVE_CLAW 0x348
#define MOVE_HARSHCLAW 0x349
#define MOVE_BRUTALCLAW 0x34A
#define MOVE_BEASTCHARGE 0x34B
#define MOVE_RUPTURE 0x34C
#define MOVE_RAWR 0x34D
#define MOVE_FERALBITE 0x34E
#define MOVE_DIREFLAIL 0x34F
#define MOVE_PLAYDEAD 0x350
#define MOVE_HUNTERMARK 0x351
#define MOVE_ADRENALINE 0x352
#define MOVE_BEASTSENSE 0x353
#define MOVE_CONCEALMENT 0x354

//Relic Type
#define MOVE_PERSEVERANCE 0x355
#define MOVE_ENTOMB 0x356
#define MOVE_CHISEL 0x357
#define MOVE_SNAGCURIO 0x358
#define MOVE_SHARDSHOT 0x359
#define MOVE_SCRAPE 0x35A
#define MOVE_TIMEGEAR 0x35B
#define MOVE_RUSTYRIVET 0x35C
#define MOVE_COREBLAST 0x35D
#define MOVE_HEIRLOOMHIT 0x35E
#define MOVE_MAINTENANCE 0x35F
#define MOVE_GAURDDRAIN 0x360
#define MOVE_REINFORCE 0x361
#define MOVE_BOLSTER 0x362
#define MOVE_FORTIFY 0x363
#define MOVE_WEIGHDOWN 0x364
#define MOVE_CAVING 0x365

//Food Type
#define MOVE_SALTRUB 0x366
#define MOVE_GUMSHOT 0x367
#define MOVE_MUNCH 0x368
#define MOVE_SYRUPSMACK 0x369
#define MOVE_MORNINGMEAL 0x36A
#define MOVE_GREEDYGRAB 0x36B
#define MOVE_REGROWTH 0x36C
#define MOVE_SUGARRUSH 0x36D
#define MOVE_FOODCOMA 0x36E
#define MOVE_TASTE 0x36F
#define MOVE_FEAST 0x370
#define MOVE_FLINGFRUIT 0x371
#define MOVE_BANQUET 0x372
#define MOVE_CHOMP 0x373
#define MOVE_DIGEST 0x374
#define MOVE_CONSUME 0x375
#define MOVE_ORDERUP 0x376

//Fungus Type
#define MOVE_SPOREBURST 0x377
#define MOVE_PUFFPUNCH 0x378
#define MOVE_MYCELIALCAGE 0x379
#define MOVE_MUSCARDINE 0x37A
#define MOVE_FERMENTEDSPRAY 0x37B
#define MOVE_SUPERSPORE 0x37C
#define MOVE_AFTEREFFECTS 0x37D
#define MOVE_MUSHYSHIELD 0x37E
#define MOVE_TRUFFLETOUCH 0x37F
#define MOVE_BADTRIP 0x380
#define MOVE_DELAYEDGROWTH 0x381
#define MOVE_LICHENLEECH 0x382
#define MOVE_BLACKMOLD 0x383
#define MOVE_PSYCHOSPORE 0x384
#define MOVE_MUSHYMESS 0x385
//Tech Type
#define MOVE_BITCRUSH 0x386
#define MOVE_HARDRESET 0x387
#define MOVE_ANTIVIRUS 0x388
#define MOVE_MEMORYLEAK 0x389
#define MOVE_OVERRIDE 0x38A
#define MOVE_WIREWHIP 0x38B
#define MOVE_HYDRAULICHIT 0x38C
#define MOVE_BRUTEFORCE 0x38D
#define MOVE_POWERSURGE 0x38E
#define MOVE_SHORTCIRCUIT 0x38F
#define MOVE_BURNOUT 0x390
#define MOVE_OVERCLOCKING 0x391
#define MOVE_COOLDOWN 0x392
#define MOVE_OVERCHARGE 0x393
#define MOVE_REBOOT 0x394

//Misc Moves
#define MOVE_SPINOUT 0x395
#define MOVE_MAKEITRAIN 0x396
#define MOVE_GEMCANNON 0x397
#define MOVE_FACETING 0x398
#define MOVE_SHADOWBLAST 0x399
#define MOVE_SHADOWDOWN 0x39A
#define MOVE_SHADOWSHED 0x39B
#define MOVE_SHADOWSTORM 0x39C
#define MOVE_SHADOWFLARE 0x39D
#define MOVE_SHADOWHOLD 0x39E
#define MOVE_SHADOWPANIC 0x39F
#define MOVE_SHADOWBREAK 0x3A0
#define MOVE_RAGEFIST 0x3A1


//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P 0x3A2
#define MOVE_BREAKNECK_BLITZ_S 0x3A3
#define MOVE_ALL_OUT_PUMMELING_P 0x3A4
#define MOVE_ALL_OUT_PUMMELING_S 0x3A5
#define MOVE_SUPERSONIC_SKYSTRIKE_P 0x3A6
#define MOVE_SUPERSONIC_SKYSTRIKE_S 0x3A7
#define MOVE_ACID_DOWNPOUR_P 0x3A8
#define MOVE_ACID_DOWNPOUR_S 0x3A9
#define MOVE_TECTONIC_RAGE_P 0x3AA
#define MOVE_TECTONIC_RAGE_S 0x3AB
#define MOVE_CONTINENTAL_CRUSH_P 0x3AC
#define MOVE_CONTINENTAL_CRUSH_S 0x3AD
#define MOVE_SAVAGE_SPIN_OUT_P 0x3AE
#define MOVE_SAVAGE_SPIN_OUT_S 0x3AF
#define MOVE_NEVER_ENDING_NIGHTMARE_P 0x3B0
#define MOVE_NEVER_ENDING_NIGHTMARE_S 0x3B1
#define MOVE_CORKSCREW_CRASH_P 0x3B2
#define MOVE_CORKSCREW_CRASH_S 0x3B3
#define MOVE_INFERNO_OVERDRIVE_P 0x3B4
#define MOVE_INFERNO_OVERDRIVE_S 0x3B5
#define MOVE_HYDRO_VORTEX_P 0x3B6
#define MOVE_HYDRO_VORTEX_S 0x3B7
#define MOVE_BLOOM_DOOM_P 0x3B8
#define MOVE_BLOOM_DOOM_S 0x3B9
#define MOVE_GIGAVOLT_HAVOC_P 0x3BA
#define MOVE_GIGAVOLT_HAVOC_S 0x3BB
#define MOVE_SHATTERED_PSYCHE_P 0x3BC
#define MOVE_SHATTERED_PSYCHE_S 0x3BD
#define MOVE_SUBZERO_SLAMMER_P 0x3BE
#define MOVE_SUBZERO_SLAMMER_S 0x3BF
#define MOVE_DEVASTATING_DRAKE_P 0x3C0
#define MOVE_DEVASTATING_DRAKE_S 0x3C1
#define MOVE_BLACK_HOLE_ECLIPSE_P 0x3C2
#define MOVE_BLACK_HOLE_ECLIPSE_S 0x3C3
#define MOVE_TWINKLE_TACKLE_P 0x3C4
#define MOVE_TWINKLE_TACKLE_S 0x3C5

#define MOVE_CATASTROPIKA 0x3C6
#define MOVE_10000000_VOLT_THUNDERBOLT 0x3C7
#define MOVE_STOKED_SPARKSURFER 0x3C8//Paralyze Target

#define MOVE_EXTREME_EVOBOOST 0x3C9//Double Ancient Power

#define MOVE_PULVERIZING_PANCAKE 0x3CA
#define MOVE_GENESIS_SUPERNOVA 0x3CB//Sets up Psychic Terrain

#define MOVE_SINISTER_ARROW_RAID 0x3CC
#define MOVE_MALICIOUS_MOONSAULT 0x3CD
#define MOVE_OCEANIC_OPERETTA 0x3CE
#define MOVE_SPLINTERED_STORMSHARDS 0x3CF//Removes Terrain

#define MOVE_LETS_SNUGGLE_FOREVER 0x3D0
#define MOVE_CLANGOROUS_SOULBLAZE 0x3D1//Ancient Power

#define MOVE_GUARDIAN_OF_ALOLA 0x3D2
#define MOVE_SEARING_SUNRAZE_SMASH 0x3D3
#define MOVE_MENACING_MOONRAZE_MAELSTROM 0x3D4
#define MOVE_LIGHT_THAT_BURNS_THE_SKY 0x3D5
#define MOVE_SOUL_STEALING_7_STAR_STRIKE 0x3D6

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

//Max Moves
#define MOVE_MAX_GUARD 0x3D7
#define MOVE_MAX_STRIKE_P 0x3D8
#define MOVE_MAX_STRIKE_S 0x3D9
#define MOVE_MAX_KNUCKLE_P 0x3DA
#define MOVE_MAX_KNUCKLE_S 0x3DB
#define MOVE_MAX_AIRSTREAM_P 0x3DC
#define MOVE_MAX_AIRSTREAM_S 0x3DD
#define MOVE_MAX_OOZE_P 0x3DE
#define MOVE_MAX_OOZE_S 0x3DF
#define MOVE_MAX_QUAKE_P 0x3E0
#define MOVE_MAX_QUAKE_S 0x3E1
#define MOVE_MAX_ROCKFALL_P 0x3E2
#define MOVE_MAX_ROCKFALL_S 0x3E3
#define MOVE_MAX_FLUTTERBY_P 0x3E4
#define MOVE_MAX_FLUTTERBY_S 0x3E5
#define MOVE_MAX_PHANTASM_P 0x3E6
#define MOVE_MAX_PHANTASM_S 0x3E7
#define MOVE_MAX_STEELSPIKE_P 0x3E8
#define MOVE_MAX_STEELSPIKE_S 0x3E9
#define MOVE_MAX_FLARE_P 0x3EA
#define MOVE_MAX_FLARE_S 0x3EB
#define MOVE_MAX_GEYSER_P 0x3EC
#define MOVE_MAX_GEYSER_S 0x3ED
#define MOVE_MAX_OVERGROWTH_P 0x3EE
#define MOVE_MAX_OVERGROWTH_S 0x3EF
#define MOVE_MAX_LIGHTNING_P 0x3F0
#define MOVE_MAX_LIGHTNING_S 0x3F1
#define MOVE_MAX_MINDSTORM_P 0x3F2
#define MOVE_MAX_MINDSTORM_S 0x3F3
#define MOVE_MAX_HAILSTORM_P 0x3F4
#define MOVE_MAX_HAILSTORM_S 0x3F5
#define MOVE_MAX_WYRMWIND_P 0x3F6
#define MOVE_MAX_WYRMWIND_S 0x3F7
#define MOVE_MAX_DARKNESS_P 0x3F8
#define MOVE_MAX_DARKNESS_S 0x3F9
#define MOVE_MAX_STARFALL_P 0x3FA
#define MOVE_MAX_STARFALL_S 0x3FB
#define MOVE_G_MAX_VINE_LASH_P 0x3FC
#define MOVE_G_MAX_VINE_LASH_S 0x3FD
#define MOVE_G_MAX_WILDFIRE_P 0x3FE
#define MOVE_G_MAX_WILDFIRE_S 0x3FF
#define MOVE_G_MAX_CANNONADE_P 0x400
#define MOVE_G_MAX_CANNONADE_S 0x401
#define MOVE_G_MAX_BEFUDDLE_P 0x402
#define MOVE_G_MAX_BEFUDDLE_S 0x403
#define MOVE_G_MAX_VOLT_CRASH_P 0x404
#define MOVE_G_MAX_VOLT_CRASH_S 0x405
#define MOVE_G_MAX_GOLD_RUSH_P 0x406
#define MOVE_G_MAX_GOLD_RUSH_S 0x407
#define MOVE_G_MAX_CHI_STRIKE_P 0x408
#define MOVE_G_MAX_CHI_STRIKE_S 0x409
#define MOVE_G_MAX_TERROR_P 0x40A
#define MOVE_G_MAX_TERROR_S 0x40B
#define MOVE_G_MAX_FOAM_BURST_P 0x40C
#define MOVE_G_MAX_FOAM_BURST_S 0x40D
#define MOVE_G_MAX_RESONANCE_P 0x40E
#define MOVE_G_MAX_RESONANCE_S 0x40F
#define MOVE_G_MAX_CUDDLE_P 0x410
#define MOVE_G_MAX_CUDDLE_S 0x411
#define MOVE_G_MAX_REPLENISH_P 0x412
#define MOVE_G_MAX_REPLENISH_S 0x413
#define MOVE_G_MAX_MALODOR_P 0x414
#define MOVE_G_MAX_MALODOR_S 0x415
#define MOVE_G_MAX_MELTDOWN_P 0x416
#define MOVE_G_MAX_MELTDOWN_S 0x417
#define MOVE_G_MAX_DRUM_SOLO_P 0x418
#define MOVE_G_MAX_DRUM_SOLO_S 0x419
#define MOVE_G_MAX_FIREBALL_P 0x41A
#define MOVE_G_MAX_FIREBALL_S 0x41B
#define MOVE_G_MAX_HYDROSNIPE_P 0x41C
#define MOVE_G_MAX_HYDROSNIPE_S 0x41D
#define MOVE_G_MAX_WIND_RAGE_P 0x41E
#define MOVE_G_MAX_WIND_RAGE_S 0x41F
#define MOVE_G_MAX_GRAVITAS_P 0x420
#define MOVE_G_MAX_GRAVITAS_S 0x421
#define MOVE_G_MAX_STONESURGE_P 0x422
#define MOVE_G_MAX_STONESURGE_S 0x423
#define MOVE_G_MAX_VOLCALITH_P 0x424
#define MOVE_G_MAX_VOLCALITH_S 0x425
#define MOVE_G_MAX_TARTNESS_P 0x426
#define MOVE_G_MAX_TARTNESS_S 0x427
#define MOVE_G_MAX_SWEETNESS_P 0x428
#define MOVE_G_MAX_SWEETNESS_S 0x429
#define MOVE_G_MAX_SANDBLAST_P 0x42A
#define MOVE_G_MAX_SANDBLAST_S 0x42B
#define MOVE_G_MAX_STUN_SHOCK_P 0x42C
#define MOVE_G_MAX_STUN_SHOCK_S 0x42D
#define MOVE_G_MAX_CENTIFERNO_P 0x42E
#define MOVE_G_MAX_CENTIFERNO_S 0x42F
#define MOVE_G_MAX_SMITE_P 0x430
#define MOVE_G_MAX_SMITE_S 0x431
#define MOVE_G_MAX_SNOOZE_P 0x432
#define MOVE_G_MAX_SNOOZE_S 0x433
#define MOVE_G_MAX_FINALE_P 0x434
#define MOVE_G_MAX_FINALE_S 0x435
#define MOVE_G_MAX_STEELSURGE_P 0x436
#define MOVE_G_MAX_STEELSURGE_S 0x437
#define MOVE_G_MAX_DEPLETION_P 0x438
#define MOVE_G_MAX_DEPLETION_S 0x439
#define MOVE_G_MAX_ONE_BLOW_P 0x44A
#define MOVE_G_MAX_ONE_BLOW_S 0x43B
#define MOVE_G_MAX_RAPID_FLOW_P 0x43C
#define MOVE_G_MAX_RAPID_FLOW_S 0x43D
...
#define NON_Z_MOVE_COUNT   (MOVE_RAGEFIST + 1)
