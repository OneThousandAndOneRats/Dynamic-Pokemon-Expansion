...
//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P 0x377
#define MOVE_BREAKNECK_BLITZ_S 0x378
#define MOVE_ALL_OUT_PUMMELING_P 0x379
#define MOVE_ALL_OUT_PUMMELING_S 0x37A
#define MOVE_SUPERSONIC_SKYSTRIKE_P 0x37B
#define MOVE_SUPERSONIC_SKYSTRIKE_S 0x37C
#define MOVE_ACID_DOWNPOUR_P 0x37D
#define MOVE_ACID_DOWNPOUR_S 0x37E
#define MOVE_TECTONIC_RAGE_P 0x37F
#define MOVE_TECTONIC_RAGE_S 0x380
#define MOVE_CONTINENTAL_CRUSH_P 0x381
#define MOVE_CONTINENTAL_CRUSH_S 0x382
#define MOVE_SAVAGE_SPIN_OUT_P 0x383
#define MOVE_SAVAGE_SPIN_OUT_S 0x384
#define MOVE_NEVER_ENDING_NIGHTMARE_P 0x385
#define MOVE_NEVER_ENDING_NIGHTMARE_S 0x386
#define MOVE_CORKSCREW_CRASH_P 0x387
#define MOVE_CORKSCREW_CRASH_S 0x388
#define MOVE_INFERNO_OVERDRIVE_P 0x389
#define MOVE_INFERNO_OVERDRIVE_S 0x38A
#define MOVE_HYDRO_VORTEX_P 0x38B
#define MOVE_HYDRO_VORTEX_S 0x38C
#define MOVE_BLOOM_DOOM_P 0x38D
#define MOVE_BLOOM_DOOM_S 0x38E
#define MOVE_GIGAVOLT_HAVOC_P 0x38F
#define MOVE_GIGAVOLT_HAVOC_S 0x390
#define MOVE_SHATTERED_PSYCHE_P 0x391
#define MOVE_SHATTERED_PSYCHE_S 0x392
#define MOVE_SUBZERO_SLAMMER_P 0x393
#define MOVE_SUBZERO_SLAMMER_S 0x394
#define MOVE_DEVASTATING_DRAKE_P 0x395
#define MOVE_DEVASTATING_DRAKE_S 0x396
#define MOVE_BLACK_HOLE_ECLIPSE_P 0x397
#define MOVE_BLACK_HOLE_ECLIPSE_S 0x398
#define MOVE_TWINKLE_TACKLE_P 0x399
#define MOVE_TWINKLE_TACKLE_S 0x39A

#define MOVE_CATASTROPIKA 0x39B
#define MOVE_10000000_VOLT_THUNDERBOLT 0x39C
#define MOVE_STOKED_SPARKSURFER 0x39D//Paralyze Target

#define MOVE_EXTREME_EVOBOOST 0x39E//Double Ancient Power

#define MOVE_PULVERIZING_PANCAKE 0x39F
#define MOVE_GENESIS_SUPERNOVA 0x3A0//Sets up Psychic Terrain

#define MOVE_SINISTER_ARROW_RAID 0x3A1
#define MOVE_MALICIOUS_MOONSAULT 0x3A2
#define MOVE_OCEANIC_OPERETTA 0x3A3
#define MOVE_SPLINTERED_STORMSHARDS 0x3A4//Removes Terrain

#define MOVE_LETS_SNUGGLE_FOREVER 0x3A5
#define MOVE_CLANGOROUS_SOULBLAZE 0x3A6//Ancient Power

#define MOVE_GUARDIAN_OF_ALOLA 0x3A7
#define MOVE_SEARING_SUNRAZE_SMASH 0x3A8
#define MOVE_MENACING_MOONRAZE_MAELSTROM 0x3A9
#define MOVE_LIGHT_THAT_BURNS_THE_SKY 0x3AA
#define MOVE_SOUL_STEALING_7_STAR_STRIKE 0x3AB

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

//Max Moves
#define MOVE_MAX_GUARD 0x3AC
#define MOVE_MAX_STRIKE_P 0x3AD
#define MOVE_MAX_STRIKE_S 0x3AE
#define MOVE_MAX_KNUCKLE_P 0x3AF
#define MOVE_MAX_KNUCKLE_S 0x3B0
#define MOVE_MAX_AIRSTREAM_P 0x3B1
#define MOVE_MAX_AIRSTREAM_S 0x3B2
#define MOVE_MAX_OOZE_P 0x3B3
#define MOVE_MAX_OOZE_S 0x3B4
#define MOVE_MAX_QUAKE_P 0x3B5
#define MOVE_MAX_QUAKE_S 0x3B6
#define MOVE_MAX_ROCKFALL_P 0x3B7
#define MOVE_MAX_ROCKFALL_S 0x3B8
#define MOVE_MAX_FLUTTERBY_P 0x3B9
#define MOVE_MAX_FLUTTERBY_S 0x3BA
#define MOVE_MAX_PHANTASM_P 0x3BB
#define MOVE_MAX_PHANTASM_S 0x3BC
#define MOVE_MAX_STEELSPIKE_P 0x3BD
#define MOVE_MAX_STEELSPIKE_S 0x3BE
#define MOVE_MAX_FLARE_P 0x3BF
#define MOVE_MAX_FLARE_S 0x3C0
#define MOVE_MAX_GEYSER_P 0x3C1
#define MOVE_MAX_GEYSER_S 0x3C2
#define MOVE_MAX_OVERGROWTH_P 0x3C3
#define MOVE_MAX_OVERGROWTH_S 0x3C4
#define MOVE_MAX_LIGHTNING_P 0x3C5
#define MOVE_MAX_LIGHTNING_S 0x3C6
#define MOVE_MAX_MINDSTORM_P 0x3C7
#define MOVE_MAX_MINDSTORM_S 0x3C8
#define MOVE_MAX_HAILSTORM_P 0x3C9
#define MOVE_MAX_HAILSTORM_S 0x3CA
#define MOVE_MAX_WYRMWIND_P 0x3CB
#define MOVE_MAX_WYRMWIND_S 0x3CC
#define MOVE_MAX_DARKNESS_P 0x3CD
#define MOVE_MAX_DARKNESS_S 0x3CE
#define MOVE_MAX_STARFALL_P 0x3CF
#define MOVE_MAX_STARFALL_S 0x3D0
#define MOVE_G_MAX_VINE_LASH_P 0x3D1
#define MOVE_G_MAX_VINE_LASH_S 0x3D2
#define MOVE_G_MAX_WILDFIRE_P 0x3D3
#define MOVE_G_MAX_WILDFIRE_S 0x3D4
#define MOVE_G_MAX_CANNONADE_P 0x3D5
#define MOVE_G_MAX_CANNONADE_S 0x3D6
#define MOVE_G_MAX_BEFUDDLE_P 0x3D7
#define MOVE_G_MAX_BEFUDDLE_S 0x3D8
#define MOVE_G_MAX_VOLT_CRASH_P 0x3D9
#define MOVE_G_MAX_VOLT_CRASH_S 0x3DA
#define MOVE_G_MAX_GOLD_RUSH_P 0x3DB
#define MOVE_G_MAX_GOLD_RUSH_S 0x3DC
#define MOVE_G_MAX_CHI_STRIKE_P 0x3DD
#define MOVE_G_MAX_CHI_STRIKE_S 0x3DE
#define MOVE_G_MAX_TERROR_P 0x3DF
#define MOVE_G_MAX_TERROR_S 0x3E0
#define MOVE_G_MAX_FOAM_BURST_P 0x3E1
#define MOVE_G_MAX_FOAM_BURST_S 0x3E2
#define MOVE_G_MAX_RESONANCE_P 0x3E3
#define MOVE_G_MAX_RESONANCE_S 0x3E4
#define MOVE_G_MAX_CUDDLE_P 0x3E5
#define MOVE_G_MAX_CUDDLE_S 0x3E6
#define MOVE_G_MAX_REPLENISH_P 0x3E7
#define MOVE_G_MAX_REPLENISH_S 0x3E8
#define MOVE_G_MAX_MALODOR_P 0x3E9
#define MOVE_G_MAX_MALODOR_S 0x3EA
#define MOVE_G_MAX_MELTDOWN_P 0x3EB
#define MOVE_G_MAX_MELTDOWN_S 0x3EC
#define MOVE_G_MAX_DRUM_SOLO_P 0x3ED
#define MOVE_G_MAX_DRUM_SOLO_S 0x3EE
#define MOVE_G_MAX_FIREBALL_P 0x3EF
#define MOVE_G_MAX_FIREBALL_S 0x3F0
#define MOVE_G_MAX_HYDROSNIPE_P 0x3F1
#define MOVE_G_MAX_HYDROSNIPE_S 0x3F2
#define MOVE_G_MAX_WIND_RAGE_P 0x3F3
#define MOVE_G_MAX_WIND_RAGE_S 0x3F4
#define MOVE_G_MAX_GRAVITAS_P 0x3F5
#define MOVE_G_MAX_GRAVITAS_S 0x3F6
#define MOVE_G_MAX_STONESURGE_P 0x3F7
#define MOVE_G_MAX_STONESURGE_S 0x3F8
#define MOVE_G_MAX_VOLCALITH_P 0x3F9
#define MOVE_G_MAX_VOLCALITH_S 0x3FA
#define MOVE_G_MAX_TARTNESS_P 0x3FB
#define MOVE_G_MAX_TARTNESS_S 0x3FC
#define MOVE_G_MAX_SWEETNESS_P 0x3FD
#define MOVE_G_MAX_SWEETNESS_S 0x3FE
#define MOVE_G_MAX_SANDBLAST_P 0x3FF
#define MOVE_G_MAX_SANDBLAST_S 0x400
#define MOVE_G_MAX_STUN_SHOCK_P 0x401
#define MOVE_G_MAX_STUN_SHOCK_S 0x402
#define MOVE_G_MAX_CENTIFERNO_P 0x403
#define MOVE_G_MAX_CENTIFERNO_S 0x404
#define MOVE_G_MAX_SMITE_P 0x405
#define MOVE_G_MAX_SMITE_S 0x406
#define MOVE_G_MAX_SNOOZE_P 0x407
#define MOVE_G_MAX_SNOOZE_S 0x408
#define MOVE_G_MAX_FINALE_P 0x409
#define MOVE_G_MAX_FINALE_S 0x40A
#define MOVE_G_MAX_STEELSURGE_P 0x40B
#define MOVE_G_MAX_STEELSURGE_S 0x40C
#define MOVE_G_MAX_DEPLETION_P 0x40D
#define MOVE_G_MAX_DEPLETION_S 0x40E
#define MOVE_G_MAX_ONE_BLOW_P 0x40F
#define MOVE_G_MAX_ONE_BLOW_S 0x410
#define MOVE_G_MAX_RAPID_FLOW_P 0x411
#define MOVE_G_MAX_RAPID_FLOW_S 0x412
...
#define NON_Z_MOVE_COUNT   (MOVE_ORDERUP + 1)
