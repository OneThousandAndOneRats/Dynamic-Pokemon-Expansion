...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_PRIMEAPE] = 		 {{EVO_MOVE, MOVE_SAVAGE, SPECIES_ANNIHILAPE, 0}},
	...
	[SPECIES_SUNKERN] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA, 0},
								  {EVO_FRIENDSHIP, 0, SPECIES_SUNFLORA, 0}},
	...
	[SPECIES_URSARING] =         {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_URSALUNA, 0}},
	...
	[SPECIES_SLOWPOKE_G] =       {{EVO_ITEM, ITEM_GALARICA_WREATH, SPECIES_SLOWBRO_G, 0},
	...
	//[SPECIES_BASCULIN_H] =       {{EVO_MOVE, MOVE_WAVECRASH, SPECIES_BASCULEGION_M, 0}},
